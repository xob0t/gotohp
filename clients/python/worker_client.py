...
class Account:
    email: str
    selected: bool = False
    needs_token_binding: bool = False
@dataclass
class UploadFile:
    path: str
    media_key: str = ""
...
class Client:
    ...
    def accounts(self) -> list[Account]:
        ...
        return [Account(a["email"], a["email"] == result.get("selected", ""), a.get("needsTokenBinding", False)) for a in result.get("accounts",[])]
